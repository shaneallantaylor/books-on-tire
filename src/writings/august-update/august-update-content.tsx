...
import type { NamedImagePropsModel } from '../../lib/cloudinary/get-images';
import { AugustImageNames, dictionary } from './constants';
...
export function AugustUpdateContent({ images }: { images: NamedImagePropsModel<AugustImageNames> }) {
